...
PIXTEL uses simple point-and-click controls:

- **Click/Tap** on the ground to walk your character
- **Click/Tap** on interactive objects (tables, furniture) to interact
- **UI buttons** for chat, friends, inventory, and settings
...
- Both players can exit the table and return to the room

Your XIPS balance updates automatically.
